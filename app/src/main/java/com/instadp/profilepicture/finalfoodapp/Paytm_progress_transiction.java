...
public class Paytm_progress_transiction extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paytm_progress_transiction);
        Intent i=getIntent();
        price=i.getStringExtra("paytm");
        orderid=i.getStringExtra("orderid");
        Log.d("12349",price);
        ProgressDialog pd = new ProgressDialog(Paytm_progress_transiction.this);
...
Intent i=new Intent(Paytm_progress_transiction.this,FinalCheckout.class);
    i.putExtra("paid",bundle.get("TXNAMOUNT").toString());
    i.putExtra("orderid1",orderid);
    i.putExtra("date",bundle.get("TXNDATE").toString());
    startActivity(i);
    Log.d("123456", bundle.get("TXNDATE").toString());
    Log.d("123456",bundle.toString());
}
    }
    ...
    public void onBackPressedCancelTransaction() {
        Toast.makeText(this, "Teansiction Failed", Toast.LENGTH_LONG).show();
    }
    @Override
